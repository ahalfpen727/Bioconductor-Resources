...
PROCESSORS=2
MEMORY="16912"      # PER PROCESSOR!! - 2048=2G, 4096=4G, 8192=8G, 16384=16G, 32768=32G, 65536=64G
DURATION="194:00"  # HH:MM - 72:00=3 days, 96:00=4 days, 192:00=8 days, 384:00=16 days
...
while IFS='' read -r line || [[ -n "$line" ]]; do   # each line is a directory that contains a accepted_hit.bam file
	...
	scriptString="mktemp -p ${SCRIPTS} -t ${COMMAND}.${i}.XXXXXXXXXXX"
	echo -e "\n${scriptString}"
