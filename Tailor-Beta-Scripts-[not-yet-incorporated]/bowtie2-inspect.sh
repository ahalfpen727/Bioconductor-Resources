...
#COMMAND_LINE="${COMMAND} -s ${BOWTIE_BASENAME}.fa > ${OUTPUT}/genome_inspection.txt"
#COMMAND_LINE="${COMMAND} -s ${MUTLIFASTA} > ${OUTPUT}"
COMMAND_LINE="${COMMAND} ${EXTRA_BOWTIE_INSPECT_PARAMETERS} > ${OUTPUT}/genome_inspection.txt"
