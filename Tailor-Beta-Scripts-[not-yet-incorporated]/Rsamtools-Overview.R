### R code from vignette source 'vignettes/Rsamtools/inst/doc/Rsamtools-Overview.Rnw'
...
###################################################
### code chunk number 14: caffeine-kegg
###################################################
library(KEGG.db)
...
###################################################
### code chunk number 15: txdb-transcripts
###################################################
...
###################################################
### code chunk number 16: bamRanges-genome
###################################################
unique(genome(bamRanges))


###################################################
### code chunk number 17: BamViews-parts
###################################################
slxMaq09 <- local({
...
###################################################
### code chunk number 18: BamViews-construct
###################################################
bamExperiment <- 
...
###################################################
### code chunk number 19: BamViews-query
###################################################
bamExperiment(bv)


###################################################
### code chunk number 20: bamIndicies (eval = FALSE)
###################################################
...
###################################################
### code chunk number 21: readBamGappedAlignments (eval = FALSE)
###################################################
## library(parallel)
...
###################################################
### code chunk number 23: read-lengths
###################################################
head(t(sapply(olaps, function(elt) range(qwidth(elt)))))


###################################################
### code chunk number 24: focal
###################################################
rng <- bamRanges(bv)[1]
strand(rng) <- "*"
...
###################################################
### code chunk number 26: olap-cvg-as-m
###################################################
...
###################################################
### code chunk number 28: bam-avail (eval = FALSE)
###################################################
## library(RCurl)
## ftpBase <- 
...
###################################################
### code chunk number 29: bam-index (eval = FALSE)
###################################################
...
###################################################
### code chunk number 30: slxMaq09 (eval = FALSE)
###################################################
## urls1 <- 
...
###################################################
### code chunk number 31: bamIndicies (eval = FALSE)
###################################################
## bamIndexDir <- tempfile()
## dir.create(bamIndexDir)
