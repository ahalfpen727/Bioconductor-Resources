...
#--------------------------------------------------------------------------------------------------------------
# Cuffdiff_leaveout - find significant changes in transcript expression, splicing, and promoter use excluding each sample at least one
#   - Groups of replicates for each experiement (case) and the sample excluded from each leaveout analysis  are defined in settings.sh
#
#   - Calls multipleCuffdiff.sh loops through the list of Samples submitting one multipleCuffdiff
#     job for each sample
#
...
#----------------------------------------------------------------------------------------------------------------------------------------
	...
	multipleCuffdiff.sh $EXPER_1_FILE $EXPER_1_NAME $EXPER_2_FILE $EXPER_2_NAME
