...
biocLite(c("RITANdata","RITAN", "EnrichmentBrowser","featureCounts", "Rsubread", "goseq","RCy3", "netbiov",
           "STRINGdb","SBMLR", "rsbml", "graphite", "graph","GraphAlignment","cogena", "paxtoolsr",
           "RbcBook1","GO","KEGG","annaffy","ALL","prada","affydata","kidpack","sma","RUVSeq","voom"))

library("prada");library("annaffy");library("affydata");library("kidpack")
library("RUVSeq");library(ALL);library("Rgraphviz");library("RBGL");
library("graph");library("RColorBrewer");library("geneplotter")
library("RbcBook1")
library(Monograph)
