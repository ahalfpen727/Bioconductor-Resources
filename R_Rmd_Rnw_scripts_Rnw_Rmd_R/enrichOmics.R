...
library("waldronlab/MultiAssayExperimentWorkshop")
library(BiocStyle)
library(ALL)
library(hgu95av2.db)
library(airway)
...
BiocInstaller::biocLite(c("curatedTCGAData", "mirbase.db","mogsa", "EnsDb.Hsapiens.v86","waldronlab/MultiAssayExperimentWorkshop"))
