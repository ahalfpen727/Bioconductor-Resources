...
bibliography: "`r system.file(package='EGSEA123', 'vignettes', 'workflow.bib')`"
---
# Easy and efficient ensemble gene set testing with EGSEA

`r knitr::include_graphics(system.file(package='EGSEA123', 'vignettes', 'EGSEA.png'))`
...
In this workshop, we follow the analysis pipeline described in [Alhamdoosh et al. (2017)](https://f1000research.com/articles/6-2010) to perform gene set enrichment analysis using the **EGSEA** package. Students will be able to follow along and questions are encouraged.
...
Participants can watch the live demo, or may prefer to follow the demonstration by bringing their laptops along. To follow the analysis on their own laptops, participants need to install the **EGSEA123** workflow by running
...
`r knitr::include_graphics(system.file(package='EGSEA123', 'vignettes', 'EGSEAWorkFlow.png'))`
...
`r knitr::include_graphics(system.file(package='EGSEA123', 'vignettes', 'mmu04270.pathview.png'))`
Pathway map for *Vascular smooth muscle contraction* (KEGG pathway mmu04270) with log-fold-changes from the Basal vs LP contrast.
...
`r knitr::include_graphics(system.file(package='EGSEA123', 'vignettes', 'mmu04270.pathview.multi.png'))`
Pathway map for *Vascular smooth muscle contraction* (KEGG pathway mmu04270) with log-fold-changes across three experimental contrasts shown for each gene in the same order left to right that they appear in the contrasts matrix (i.e. Basal vs LP, Basal vs ML and LP vs ML).
...
`r knitr::include_graphics(system.file(package='EGSEA123', 'vignettes', 'egsea_report_small.png'))`
