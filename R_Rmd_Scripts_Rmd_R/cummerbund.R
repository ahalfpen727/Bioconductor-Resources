...
#############################################################################################
setwd("/media/drew/2f1bee59-e3b3-4af3-9055-b88f7a7084e9/umb_triley/urine1/cuffdiff_results_hg38_default/LUTS-over-CTRL")
dir()
wd<-dirname("/media/drew/2f1bee59-e3b3-4af3-9055-b88f7a7084e9/umb_triley/urine1/cuffdiff_results_hg38_default/LUTS-over-CTRL/")
setwd(wd)
wdir<-dir()
wdir
hg38.genome<-file.path("/media/drew/2f1bee59-e3b3-4af3-9055-b88f7a7084e9/umb_triley/urine1/cuffdiff_results_hg38_default/LUTS-over-CTRL/hg38.fa")
refgtf<-file.path("/media/drew/2f1bee59-e3b3-4af3-9055-b88f7a7084e9/umb_triley/urine1/cuffdiff_results_hg38_default/LUTS-over-CTRL/hg38.gtf")
gtf<-GTFFile("/media/drew/2f1bee59-e3b3-4af3-9055-b88f7a7084e9/umb_triley/urine1/cuffdiff_results_hg38_default/LUTS-over-CTRL/hg38.gtf")
gtf.file<-readGFF(filepath = GTF)

geneListString<-c("CXCL12","TGFB","MYC","RAS","CXCR4","IL8","IL6")
cuff<-readCufflinks(dir=".",rebuild=T)
cuff<-readCufflinks(dir=".", gtfFile="hg38.gtf",genome="hg38.fa", rebuild=T, verbose=T,warnings)
cuff<-readCufflinks(dir=".", gtfFile=refgtf,genome=grch38.genome,rebuild=T)
