...
library(biomaRt)
bioc("Rcytoscape")
library("Rcytoscape");library("SRAdb");library("RITAN")
library("NetworkViews");library("cogena");library("iBBiG")
library("EGSEA")
library("SeqGSEA")
library("RCy3");library("RITANdata");library("LOLA")
library("goProfiles");library("mgsa")
library("mdgsa");library("BgeeDB")
library("GSVA")
library("fgsea")
...
library("GOfuncR")
library("CoRegNet")
library("ScISI");library("metaSeq")

library("MLSeq")
library("SplicingGraphs")
library("bridge");library("tracktables");library("Risa")
```
```
...
biocLite(c("SRAdb","RCy3","RITAN","RITANdata",
           "Cytoscape-and-NDEx","NetworkViews",
           "LOLA", "goProfiles", "mgsa","mdgsa", "cogena",
           "BgeeDB", "iBBiG", "EGSEA", "SeqGSEA", "GSVA",
           "fgsea","PathwaySplice","SISPA","GISPA","GOfuncR",
           "RNASeqR","CoRegNet","ScISI", "MLSeq",
           "SplicingGraphs", "bridge", "tracktables",
           "Risa","metaSeq"))
```
