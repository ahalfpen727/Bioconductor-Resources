...
noOVERmfGOdata <- new("topGOdata",ontology = "MF",allGenes = QvalnoOVER, nodeSize = 5,
	       	  			     annot = annFUN.org,mapping = "org.Hs.eg.db",geneSel = topDiffGenes,
					     	       ID = "symbol")
under.upMFGOdata <- new("topGOdata",ontology = "MF",allGenes = QvalUNDERhi,  annot = annFUN.org,
                        nodeSize = 5,geneSel = topDiffGenes, mapping = "org.Hs.eg.db",
                        ID = "symbol")
 noOVERccGOdata <- new("topGOdata",ontology = "CC",allGenes = QvalnoOVER, nodeSize = 5,
	       	  			     annot = annFUN.org,mapping = "org.Hs.eg.db",geneSel = topDiffGenes,
					     	       ID = "symbol")
under.upCCGOdata <- new("topGOdata",ontology = "CC",allGenes = QvalUNDERhi,  annot = annFUN.org,
                        nodeSize = 5,geneSel = topDiffGenes, mapping = "org.Hs.eg.db",
                        ID = "symbol")
