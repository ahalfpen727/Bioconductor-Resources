...
biocLite(c("gage","gageData", "DESeq2",
           "DESeq","SRAdb","DLBCL", "BioNet",
           "Stringdb", "ALL", "outliers",
           "nortest", "pathview", "qvalue",
           "GEOquery","ArrayExpress"))

biocLite(c("maPooling"))

biocLite(c("GEOquery", "BioNet", "DLBCL", "graphite","edgeR", "DESeq", "DOSE", "GOstats", "gage", "gageData", "pathview", "keggorthology", "STRINGdb", "topGO", "clusterProfiler", "org.Hs.eg.db", "org.Dm.eg.db", "ReactomePA", "Path2PPI", "KEGG.db", "KEGGgraph", "graphite", "GSEABase","RedeR", "edgeR", "DESeq", "qvalue", "outliers", "nortest", "ALL"))

library(graphite)
library(ArrayExpress);library(GOstats)
...
library(cummeRbund);library(multtest); library(reshape2)
