...
#biocLite("topGO");biocLite("org.Hs.eg.db")
biocM(c("ReactomePA","clusterProfiler","topGO","GOstats"))
...
library(cummeRbund);library(biomartr);library(reactome.db)
library(org.Mm.eg.db);library(org.Hs.eg.db);library(GSEABase)
library(GO.db);library(KEGG.db);library(DOSE); library(pathview)
library(topGO);library(clusterProfiler);library(ReactomePA)
###############################################################################
# GOplots for Significantly differentially expressed features: method 1
############################################################################
